...
/*   Updated: 2023/02/13 14:19:33 by anloisea         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_forward(t_data *data)
{
	...
	c = data->map.map[(int)(data->map.pos.y - 0.05
			+ data->map.dir.y * FRONT_SPEED)][(int)data->map.pos.x];
	d = data->map.map[(int)(data->map.pos.y + 0.05
			+ data->map.dir.y * FRONT_SPEED)][(int)data->map.pos.x];
	if (c != '1' && d != '1')
...
void	move_left(t_data *data)
{
	...
	c = data->map.map[(int)(data->map.pos.y
			+ 0.05 - data->map.plane.y * TRANS_SPEED)][(int)data->map.pos.x];
	d = data->map.map[(int)(data->map.pos.y
			- 0.05 - data->map.plane.y * TRANS_SPEED)][(int)data->map.pos.x];
	if (c != '1' && d != '1')
